...
public class TerraStyle extends Style {
    ...
    /*private Color getCategoryColor(String categoryName) {
        if (categoryName.equalsIgnoreCase("combat")) {
            return new Color(0, 185, 255, 175);
        }
        ...
        if (categoryName.equalsIgnoreCase("client")) {
            return new Color(0, 185, 255, 175);
        }
        if (categoryName.equalsIgnoreCase("targets")) {
            return new Color(0, 185, 255, 175);
        }
    ...
    private Color getCategoryColor(String categoryName) {
        return new Color(hud.getThemeColorR(), hud.getThemeColorG(), hud.getThemeColorB(), 175);
    }
