...
@ModuleInfo(name = "Tower", description = "Allow you to bridge faster", category = ModuleCategory.WORLD)
class Tower : Module() {
    /**
     * OPTIONS
     */
    ...
    fun onRender2D(event: Render2DEvent) {
        if (counterDisplayValue.get()) {
            GL11.glPushMatrix()
            val blockOverlay = Terra.moduleManager.getModule(BlockOverlay::class.java) as BlockOverlay
