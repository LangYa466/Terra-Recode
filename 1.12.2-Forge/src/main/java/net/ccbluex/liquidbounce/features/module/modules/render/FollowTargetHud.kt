...
@ModuleInfo(name = "FollowTargetHud", description = "Follow target health hud.", category = ModuleCategory.RENDER)
class FollowTargetHud : Module() {
    private val modeValue = ListValue("Mode", arrayOf("Juul", "Jello", "Material", "FDP", "Arris"), "Arris")
    ...
    private val translateY = FloatValue("TranslateY", 0F, -2F, 2F)
    private val translateX = FloatValue("TranslateX", 2F, -2F, 2F)
    ...
    private fun renderNameTag(entity: IEntityLivingBase, tag: String) {
        ...
        val killAura = Terra.moduleManager.getModule(KillAura::class.java) as KillAura
