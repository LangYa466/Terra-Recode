...
public class ValuesConfig extends FileConfig {
    ...
    protected void loadConfig() throws IOException {
        ...
        while(iterator.hasNext()) {
            ...
            if (entry.getKey().equalsIgnoreCase("CommandPrefix")) {
                Terra.commandManager.setPrefix(entry.getValue().getAsCharacter());
                ...
                final Module module = Terra.moduleManager.getModule(entry.getKey());
    ...
    protected void saveConfig() throws IOException {
        ...
        jsonObject.addProperty("CommandPrefix", Terra.commandManager.getPrefix());
        ...
        Terra.moduleManager.getModules().stream().filter(module -> !module.getValues().isEmpty()).forEach(module -> {
