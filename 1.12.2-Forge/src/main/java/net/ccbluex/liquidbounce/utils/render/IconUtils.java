...
public final class IconUtils {
    ...
    public static ByteBuffer[] getFavicon() {
        try {
            return new ByteBuffer[] {readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/" + "terra" + "/icon16x.png")), readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/" + "terra" + "/icon32x.png"))};
        }catch(IOException e) {
            e.printStackTrace();
        }
        return null;
