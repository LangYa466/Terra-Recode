...
public class ArmorComparator extends MinecraftInstance implements Comparator<ArmorPiece> {
    ...
    public int compare(ArmorPiece o1, ArmorPiece o2) {
        ...
        int durability1 = o1a.getArmorMaterial().getDurability(o1a.getArmorType());
        int durability2 = o2a.getArmorMaterial().getDurability(o2a.getArmorType());
        if (durability1 == 240 && durability2 == 240) {
