...
fun main() {
    ...
    val label = JLabel(Terra::class.java.getResourceAsStream("/instructions.html").reader().readText()
            .replace("{assets}", Terra.javaClass.classLoader.getResource("assets").toString()))
